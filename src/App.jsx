...
function App() {
  ...
  const [apiLink, setApiLink] = useState(
    "https://hostel-management-omega.vercel.app"
  );
          ...
          <Routes>
            ...
            >
              <Route
                index
                element={
                  <Login state={state} apiLink={apiLink} setState={setState} />
                }
              />
            </Route>
            ...
            >
              <Route
                index
                element={<Dashboard state={state} apiLink={apiLink} />}
              />
              ...
              <Route path="block">
                <Route
                  index
                  element={<Block state={state} apiLink={apiLink} />}
                />
                <Route
                  path=":blockId"
                  element={<RoomBlock state={state} apiLink={apiLink} />}
                />
              </Route>
